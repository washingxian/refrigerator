...
def parse_args(img_dir=None):
    ...
    parser.add_argument("--image_dir", type=str,default=img_dir)
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir", type=str,default="inference/ch_ppocr_mobile_v2.0_det_infer")
    ...
    parser.add_argument("--det_db_unclip_ratio", type=float, default=3.0)
    ...
    parser.add_argument("--rec_model_dir", type=str,default="inference/ch_ppocr_mobile_v2.0_rec_infer")
    ...
    parser.add_argument(
        "--vis_font_path", type=str, default="./tools/infer/fonts/simfang.ttf")
