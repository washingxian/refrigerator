...
rec_model_dir = "./iinference/ch_ppocr_server_v2.0_rec_infer/"
...
paddle_ocr_engin = OCR(det_model_dir= det_model_dir ,rec_model_dir= rec_model_dir ,cls_model_dir= cls_model_dir
                       ,use_angle_cls=True)

def ocr(img_path):
    res = paddle_ocr_engin.ocr_new(img_path)
    print(res)
    return align_text(res)
